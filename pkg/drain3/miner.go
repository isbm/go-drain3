...
func (m *TemplateMiner) Teardown(ctx context.Context) error {
	if err := m.persistence.Teardown(ctx); err != nil {
...
func (m *TemplateMiner) FlushStorage() (string, error) {
	return m.persistence.Flush()
}
